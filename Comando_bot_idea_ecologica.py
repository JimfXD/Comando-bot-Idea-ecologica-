...
ideas_ecologicas = ["1- Utiliza el transporte público. Nos hemos acostumbrado a utilizar el coche para todo, pero es hora de pensar en el planeta y en nuestro futuro y de usar medios de transporte más sostenibles y respetuosos con el medioambiente. El transporte público es una buena solución, así como la Bicicleta, más barata y menos contaminante que el coche.", 
"2- Reduce, reutiliza y recicla: Minimiza tu consumo de productos desechables y trata de reutilizar o reciclar tanto como sea posible. (para dejarlo simple).",
...
async def idea_ecologica(ctx, *choices: str):
